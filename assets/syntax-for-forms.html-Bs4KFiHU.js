...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,55),q=e(`<h3 id="dropdown-field" tabindex="-1"><a class="header-anchor" href="#dropdown-field" aria-hidden="true">#</a> Dropdown Field</h3><p>The <code>dropdown</code> field provides a dropdown menu. The <code>select</code> options may be defined in the <code>options</code> array.</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code>  <span class="token punctuation">-</span> <span class="token key atrule">type</span><span class="token punctuation">:</span> dropdown
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="using-the-extension-helper" tabindex="-1"><a class="header-anchor" href="#using-the-extension-helper" aria-hidden="true">#</a> Using the Extension Helper</h3>`,2),R=s("code",null,"OWN3D.ext.onContext(...)",-1),A=e(`<div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token constant">OWN3D</span><span class="token punctuation">.</span>ext<span class="token punctuation">.</span><span class="token function">onContext</span><span class="token punctuation">(</span><span class="token punctuation">(</span>context<span class="token punctuation">,</span> changed<span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="`+m+`" alt="img.png"></p><h2 id="demo-mode" tabindex="-1"><a class="header-anchor" href="#demo-mode" aria-hidden="true">#</a> Demo-Mode</h2><p>Add <code>has_demo_mode: true</code> to the manifest.yaml. This will add a &quot;Demo-Mode&quot;-Box to the Settings in the Scene-Builder.</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">id</span><span class="token punctuation">:</span> 98f9fab0<span class="token punctuation">-</span>0714<span class="token punctuation">-</span>46d8<span class="token punctuation">-</span>ac77<span class="token punctuation">-</span>d57130a1dc88
<span class="token key atrule">inputs</span><span class="token punctuation">:</span>
  <span class="token punctuation">[</span><span class="token punctuation">...</span><span class="token punctuation">]</span>
<span class="token key atrule">has_demo_mode</span><span class="token punctuation">:</span> <span class="token boolean important">true</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="`+b+`" alt="test-mode.png"></p><p>Changing the toggle, the Supervisor gets an update:</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token constant">OWN3D</span><span class="token punctuation">.</span>ext<span class="token punctuation">.</span><span class="token function">onContext</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">context<span class="token punctuation">,</span> changed</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
  <span class="token comment">// changed =&gt; [&#39;demo_mode&#39;]</span>
  <span class="token comment">// context[&#39;demo_mode&#39;] =&gt; true|false</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,8);function C(W,N){const i=t("Badge"),l=t("RouterLink"),p=t("ExternalLinkIcon");return u(),d("div",null,[s("h1",h,[f,n(" Syntax for Forms "),a(i,{text:"public beta",type:"warning"})]),g,r("\n### Divider\n\nThe `divider` field displays a horizontal line and provides no other functionaliy.\n```yaml\n  - type: divider\n    id: divider\n```\n"),q,s("p",null,[n("When a file is uploaded using this field, OWN3D will store the file for you. The file will be stored in the OWN3D CDN and will be available until the file is deleted. The "),x,n(" of the field will be the file id which can be used to retrieve the file using the "),a(l,{to:"/docs/file-storage.html"},{default:o(()=>[n("File Storage API")]),_:1}),n(".")]),w,s("p",null,[n("The "),T,n(" field provides a multi input field for font settings. It provides a list of fonts that are available in "),s("a",_,[n("Bunny Fonts"),a(p)]),n(" (the font provider for OWN3D and equivalent to Google Fonts).")]),j,s("p",null,[n("The values are received using the "),s("a",F,[n("TBD"),a(p)]),n(" endpoint. The following example shows how data is represented in the API:")]),I,s("p",null,[n("The values are received using the "),a(l,{to:"/docs/extensions/extension-helper.html"},{default:o(()=>[n("Extension Helper")]),_:1}),n(" method "),R,n(". The following example shows how to receive the values from the form:")]),A])}const S=c(y,[["render",C],["__file","syntax-for-forms.html.vue"]]);export{S as default};
