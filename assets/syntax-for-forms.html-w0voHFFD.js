...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="divider" tabindex="-1"><a class="header-anchor" href="#divider" aria-hidden="true">#</a> Divider</h3><p>The <code>divider</code> field displays a horizontal line and provides no other functionaliy.</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code>  <span class="token punctuation">-</span> <span class="token key atrule">type</span><span class="token punctuation">:</span> divider
    <span class="token key atrule">id</span><span class="token punctuation">:</span> divider
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="dropdown-field" tabindex="-1"><a class="header-anchor" href="#dropdown-field" aria-hidden="true">#</a> Dropdown Field</h3><p>The <code>dropdown</code> field provides a dropdown menu. The <code>select</code> options may be defined in the <code>options</code> array.</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code>  <span class="token punctuation">-</span> <span class="token key atrule">type</span><span class="token punctuation">:</span> dropdown
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="how-files-are-stored" tabindex="-1"><a class="header-anchor" href="#how-files-are-stored" aria-hidden="true">#</a> How Files Are Stored</h4>`,67),f=s("code",null,"value",-1),g=s("h3",{id:"font-settings-field",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#font-settings-field","aria-hidden":"true"},"#"),n(" Font Settings Field")],-1),q=s("code",null,"font-settings",-1),x={href:"https://fonts.bunny.net/",target:"_blank",rel:"noopener noreferrer"},w=e(`<div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code>  <span class="token punctuation">-</span> <span class="token key atrule">type</span><span class="token punctuation">:</span> font<span class="token punctuation">-</span>settings
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="using-the-extension-helper" tabindex="-1"><a class="header-anchor" href="#using-the-extension-helper" aria-hidden="true">#</a> Using the Extension Helper</h3>`,2),j=s("code",null,"OWN3D.ext.onContext(...)",-1),F=e(`<div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token constant">OWN3D</span><span class="token punctuation">.</span>ext<span class="token punctuation">.</span><span class="token function">onContext</span><span class="token punctuation">(</span><span class="token punctuation">(</span>context<span class="token punctuation">,</span> changed<span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="`+v+'" alt="img.png"></p>',2);function I(R,A){const i=t("Badge"),l=t("RouterLink"),o=t("ExternalLinkIcon");return u(),d("div",null,[s("h1",b,[h,n(" Syntax for Forms "),a(i,{text:"public beta",type:"warning"})]),y,s("p",null,[n("When a file is uploaded using this field, OWN3D will store the file for you. The file will be stored in the OWN3D CDN and will be available until the file is deleted. The "),f,n(" of the field will be the file id which can be used to retrieve the file using the "),a(l,{to:"/docs/file-storage.html"},{default:p(()=>[n("File Storage API")]),_:1}),n(".")]),g,s("p",null,[n("The "),q,n(" field provides a multi input field for font settings. It provides a list of fonts that are available in "),s("a",x,[n("Bunny Fonts"),a(o)]),n(" (the font provider for OWN3D and equivalent to Google Fonts).")]),w,s("p",null,[n("The values are received using the "),s("a",T,[n("TBD"),a(o)]),n(" endpoint. The following example shows how data is represented in the API:")]),_,s("p",null,[n("The values are received using the "),a(l,{to:"/docs/extensions/extension-helper.html"},{default:p(()=>[n("Extension Helper")]),_:1}),n(" method "),j,n(". The following example shows how to receive the values from the form:")]),F])}const N=c(m,[["render",I],["__file","syntax-for-forms.html.vue"]]);export{N as default};
