...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,50),g=e(`<h3 id="dropdown-field" tabindex="-1"><a class="header-anchor" href="#dropdown-field" aria-hidden="true">#</a> Dropdown Field</h3><p>The <code>dropdown</code> field provides a dropdown menu. The <code>select</code> options may be defined in the <code>options</code> array.</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code>  <span class="token punctuation">-</span> <span class="token key atrule">type</span><span class="token punctuation">:</span> dropdown
