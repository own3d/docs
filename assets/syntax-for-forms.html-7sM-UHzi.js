...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="limitations" tabindex="-1"><a class="header-anchor" href="#limitations" aria-hidden="true">#</a> Limitations</h3><ul><li>The <code>id</code> of the form must match the <code>id</code> of the extension.</li><li>The <code>id</code> of the inputs must be unique and cannot be <code>extension</code>.</li><li>The <code>id</code> of the inputs must be an alphanumeric string with a length of 3-32 characters and may contain dashes and underscores.</li></ul><h2 id="fields" tabindex="-1"><a class="header-anchor" href="#fields" aria-hidden="true">#</a> Fields</h2><h3 id="boolean-field" tabindex="-1"><a class="header-anchor" href="#boolean-field" aria-hidden="true">#</a> Boolean Field</h3><p>The <code>boolean</code> field may be used to represent a <code>boolean</code> / <code>on/off</code> value. The resulting <code>values</code> will be represented as a boolean value.</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code>  <span class="token punctuation">-</span> <span class="token key atrule">type</span><span class="token punctuation">:</span> boolean
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="checkbox-field" tabindex="-1"><a class="header-anchor" href="#checkbox-field" aria-hidden="true">#</a> Checkbox Field</h3><div class="custom-container warning"><p class="custom-container-title">WARNING</p><p><strong>Migration Required:</strong> The <code>checkbox</code> field has been updated to return an array of selected values. Previously, it returned an object with the selected value as the key and a boolean as the value.</p><p>Please update your code to handle the new format as shown in the example below.</p><p>Use <code>version: 2</code> in the field to enable the new format. The new format will be enabled by default in the future. To stay compatible with the old format, use <code>version: 1</code>.</p></div><p>The <code>checkbox</code> field may be used to represent a <code>boolean</code> / <code>on/off</code>value. The resulting <code>values</code> will be represented as an array of selected values.</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code>  <span class="token punctuation">-</span> <span class="token key atrule">type</span><span class="token punctuation">:</span> checkbox
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="color-field" tabindex="-1"><a class="header-anchor" href="#color-field" aria-hidden="true">#</a> Color Field</h3><p>The <code>color</code> field provides a color picker that can be used to select a color. The <code>value</code> must be a valid hex color code. The hex code can be either 6 or 8 characters long. The 8 character hex code will be used for the alpha channel.</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code>  <span class="token punctuation">-</span> <span class="token key atrule">type</span><span class="token punctuation">:</span> color
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,47),g=e(`<h3 id="dropdown-field" tabindex="-1"><a class="header-anchor" href="#dropdown-field" aria-hidden="true">#</a> Dropdown Field</h3><p>The <code>dropdown</code> field provides a dropdown menu. The <code>select</code> options may be defined in the <code>options</code> array.</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code>  <span class="token punctuation">-</span> <span class="token key atrule">type</span><span class="token punctuation">:</span> dropdown
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="select-field" tabindex="-1"><a class="header-anchor" href="#select-field" aria-hidden="true">#</a> Select Field</h3><div class="custom-container danger"><p class="custom-container-title">DANGER</p><p><strong>Deprecated</strong>: The <code>select</code> field is deprecated and will be removed in the future. Please use the <code>dropdown</code> field instead or various other fields like <code>chips</code> or <code>tags</code>.</p><p><strong>Limited Support</strong>: The select field currently only supports the <code>grid</code> style.</p></div><p>The <code>select</code> field provides different ways to represent a select menu. Options may be defined in the <code>options</code> array.</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code>  <span class="token punctuation">-</span> <span class="token key atrule">type</span><span class="token punctuation">:</span> select
  ...
  <span class="token property">&quot;values&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token property">&quot;my-select&quot;</span><span class="token operator">:</span> <span class="token punctuation">[</span>
      <span class="token string">&quot;option-1&quot;</span>
    <span class="token punctuation">]</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="organizing-fields" tabindex="-1"><a class="header-anchor" href="#organizing-fields" aria-hidden="true">#</a> Organizing Fields</h2><p>Sometimes it is necessary to group fields together. This allows you to structure the form in a more appealing way and makes it easier for the user to understand the form. The following fields can be used to group fields:</p><table><thead><tr><th>Field</th><th>Description</th></tr></thead><tbody><tr><td><a href="#accordion-field">Accordion</a></td><td>A group of fields that can be collapsed and expanded.</td></tr><tr><td><a href="#group-field">Group</a></td><td>Visually combines other fields into a group.</td></tr><tr><td><a href="#search-field">Search</a></td><td>Makes it possible to search through fields and their ancestors.</td></tr><tr><td><a href="#tabs-field">Tabs</a></td><td>Provides a tab bar with defined tabs to structure and group other fields.</td></tr></tbody></table><h3 id="accordion-field" tabindex="-1"><a class="header-anchor" href="#accordion-field" aria-hidden="true">#</a> Accordion Field</h3><p>The <code>accordion</code> field can be used to group any number of other fields.</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code>  <span class="token punctuation">-</span> <span class="token key atrule">type</span><span class="token punctuation">:</span> accordion
    ...
    <span class="token key atrule">fields</span><span class="token punctuation">:</span>
      ...
      <span class="token punctuation">-</span> <span class="token key atrule">type</span><span class="token punctuation">:</span> input
        ...
        <span class="token key atrule">validations</span><span class="token punctuation">:</span>
          <span class="token key atrule">required</span><span class="token punctuation">:</span> <span class="token boolean important">true</span>
      <span class="token punctuation">-</span> <span class="token punctuation">...</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>The field does not store any values.</p><h3 id="group-field" tabindex="-1"><a class="header-anchor" href="#group-field" aria-hidden="true">#</a> Group Field</h3><p>The <code>group</code> field can be used to visually combine other fields into a group.</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code>  <span class="token punctuation">-</span> <span class="token key atrule">type</span><span class="token punctuation">:</span> group
  ...
  <span class="token punctuation">-</span> <span class="token key atrule">id</span><span class="token punctuation">:</span> message<span class="token punctuation">-</span>timeout
    <span class="token key atrule">if</span><span class="token punctuation">:</span> values.options.includes(&#39;hide<span class="token punctuation">-</span>old<span class="token punctuation">-</span>messages&#39;)
